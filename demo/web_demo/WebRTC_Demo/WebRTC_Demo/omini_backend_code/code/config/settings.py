...
class LiveKitSettings(BaseSettings):
    """LiveKit配置"""
    # 🔧 [LiveKit Cloud] 硬编码配置，避免环境变量/配置文件未生效问题
    url: str = Field(default="wss://test-ummgc1t8.livekit.cloud", description="LiveKit服务器URL")
    api_key: str = Field(default="API6QFxm5wYzKns", description="LiveKit API Key")
    api_secret: str = Field(default="uLov2kCeGfuCKWEHRfCyW5nz6DlNCWKxQ2OBUnwXVvJA", description="LiveKit API Secret")
